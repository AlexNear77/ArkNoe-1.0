if(process.env.NODE_ENV !== 'production'){// si no estoy en produccion voy a utilizar ...process.env.NODE_ENV nos da el entorno actual del proyecto (dev o produccion)
   ...
   dotenv.config(); // lo que hace es que si existe un archivo al inicio del proyecto llamdo .env va a leer lo que tiene dentro y lo asignara a las variables de entorno
